...
| [ai-dev-workflow](https://github.com/soft6096/ai-dev-workflow) | 项目流程，技术方案阶段含工程结构设计 |
...
| [test-standards](https://github.com/soft6096/test-standards) | 测试规范，无直接引用 |

## 安装

```bash
git clone git@github.com:soft6096/build-standards.git ~/.agents/skills/build-standards
```
